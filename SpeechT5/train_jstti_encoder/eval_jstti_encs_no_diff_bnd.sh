...
### FOR all runs that uses precomputed speech tokens
...
CKPT_PATH=${DATA_DIR}/model_codebook_0.3_clsattn_bnd_kmeans_encoder_only_retry_2024_2l_no_diff_bnd/

echo "dumping VALID_TRUE"
python dump_prediction.py $DATA_DIR --ckpt-path $CKPT_PATH/checkpoint_best.pt --user-dir $USER_DIR  --max-text-positions 100 --split "discrete_speech_valid_true_clsattnbndkmeans|text_valid_true" --postfix "valid_true_layer_0" --use-discrete-labels 1 --tgt-enc-layer 0
