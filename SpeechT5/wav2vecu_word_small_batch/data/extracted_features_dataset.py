...
class ExtractedFeaturesDataset(FairseqDataset):
    def __init__(
        ...
        #     with open('/nobackup/users/junruin2/data/vg_hubert/libri-train-clean/feat_vg_hubert_3_9_ori_feats_no_sil_wav2bnd_gradseg/top_1024/km_dir_1024/feats_for_l1_clsattnbndkmeans/train_bnd_errors.txt', 'r') as f:
        #         bad_lines = f.readlines()
        # elif '/valid_true' in data_path:
        #     with open('/nobackup/users/junruin2/data/vg_hubert/libri-train-clean/feat_vg_hubert_3_9_ori_feats_no_sil_wav2bnd_gradseg/top_1024/km_dir_1024/feats_for_l1_clsattnbndkmeans/valid_true_bnd_errors.txt', 'r') as f:
        #         bad_lines = f.readlines()
        # else:
        #     with open('/nobackup/users/junruin2/data/vg_hubert/libri-train-clean/feat_vg_hubert_3_9_ori_feats_no_sil_wav2bnd_gradseg/top_1024/km_dir_1024/feats_for_l1_clsattnbndkmeans/valid_bnd_errors.txt', 'r') as f:
        #         bad_lines = f.readlines()            

        with open(data_path + '_bnd_errors.txt', 'r') as f:
            bad_lines = f.readlines()
        ...
        print('fn_len', len(self.filenames))
        ...
        with open(data_path + ".lengths", "r") as len_f, open(
            ...
            for file_idx, line in enumerate(len_f):
                ...
                if file_idx not in self.bad_idxs:
    ...
    def collater(self, samples):
        ...
        res = {
            "id": ids,
            "net_input": {"id": ids, "features": collated_features, "padding_mask": padding_mask},
        }
