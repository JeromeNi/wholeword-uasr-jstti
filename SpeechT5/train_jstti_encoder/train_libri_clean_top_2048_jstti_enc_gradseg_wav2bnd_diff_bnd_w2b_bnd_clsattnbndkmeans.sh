...
wrd_bnd_type=your_flag_for_wav2bnd_large_trained_on_jsttie2e_bnds # be consistent with the naming of the word boundaries
...
# point to the previosly trained JSTTI model under JSTTI E2E-refinement
wrd_bnd_type_for_gradsegwav2bnd_bnds=your_flag_for_gradseg_wav2bnd_bnds
INIT_MODEL_DIR=/path/to/data/libri-train-clean-top-${topk}/feat_${feature_type}_no_sil_${wrd_bnd_type_for_gradsegwav2bnd}/top_${topk}/km_dir_${topk}/model_codebook_0.0_clsattn_bnd_kmeans_encoder_only_retry_2024_2l_with_diff_bnd/checkpoint_best.pt
