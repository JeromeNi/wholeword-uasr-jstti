...
wrd_bnd_type=your_flag_for_gt_bnds # be consistent with the naming of the word boundaries
...
INIT_MODEL_DIR=/path/to/data/libri-train-clean-top-${topk}/feat_${feature_type}_no_sil_${wrd_bnd_type_for_wav2bnd_large_bnds}/top_${topk}/km_dir_${topk}/model_codebook_0.3_clsattn_bnd_kmeans_encoder_only_retry_2024_2l_no_diff_bnd/checkpoint_best.pt
