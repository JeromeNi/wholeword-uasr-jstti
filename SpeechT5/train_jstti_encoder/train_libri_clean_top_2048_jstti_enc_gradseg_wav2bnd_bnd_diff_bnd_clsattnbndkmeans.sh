...
wrd_bnd_type=your_flag_for_gradseg_wav2bnd_bnds # be consistent with the naming of the word boundaries
...
SAVE_DIR=$DATA_ROOT/model_codebook_0.0_clsattn_bnd_kmeans_encoder_only_retry_2024_2l_with_diff_bnd
...
# point to the previosly trained JSTTI model using VG-HuBERT segmentation
INIT_MODEL_DIR=/path/to/data/libri-train-clean-top-${topk}/feat_${feature_type}_no_sil_${wrd_bnd_type}/top_${topk}/km_dir_${topk}/model_codebook_0.3_clsattn_bnd_kmeans_encoder_only_retry_2024_2l_no_diff_bnd/checkpoint_best.pt
