...
if __name__ == "__main__":
    ...
    bad_files = []
    if 'clsattnbndkmeans' in speech_split and '_from' in speech_split:
        with open(os.path.join('/nobackup/users/junruin2/data/vg_hubert/libri-train-clean/feat_vg_hubert_3_9_ori_feats_no_sil_wav2bnd_gradseg/top_1024/km_dir_1024/', speech_split[:speech_split.rfind('clsattnbndkmeans') + len('clsattnbndkmeans')], 'bnd_errors.txt'), 'r') as f:
            bad_lines = f.readlines()
    elif 'clsattnbndkmeans' in speech_split:
        ...
        with open(os.path.join('/nobackup/users/junruin2/data/vg_hubert/libri-train-clean/feat_vg_hubert_3_9_ori_feats_no_sil_wav2bnd_gradseg/top_1024/km_dir_1024/', speech_split.replace('_gt_kmeans', '_clsattnbndkmeans'), 'bnd_errors.txt'), 'r') as f:
            bad_lines = f.readlines()
    elif '_from' in speech_split:
        with open(os.path.join('/nobackup/users/junruin2/data/vg_hubert/libri-train-clean/feat_vg_hubert_3_9_ori_feats_no_sil_wav2bnd_gradseg/top_1024/km_dir_1024/', speech_split[:speech_split.rfind('_from_')] + '_clsattnbndkmeans', 'bnd_errors.txt'), 'r') as f:
            bad_lines = f.readlines()
    else:
    ...
    os.makedirs(op.join(os.path.dirname(args.ckpt_path), f'predictions_with_fn'), exist_ok=True)
    if uer_1 > uer_2:
        with open(op.join(os.path.dirname(args.ckpt_path), f'predictions_with_fn', f'{args.postfix}_preds.txt'), 'w') as f:
    ...
    with open(op.join(os.path.dirname(args.ckpt_path), f'predictions_with_fn', f'{args.postfix}_ref.txt'), 'w') as f:
