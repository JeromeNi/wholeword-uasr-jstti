...
python dump_boundary.py $DATA_DIR --ckpt-path $CKPT_PATH/checkpoint_best.pt --user-dir $USER_DIR --split "discrete_speech_valid_true_clsattnbndkmeans|text_valid_true"


python dump_boundary.py $DATA_DIR --ckpt-path $CKPT_PATH/checkpoint_best.pt --user-dir $USER_DIR --split "discrete_speech_train_clsattnbndkmeans|text_train"

python dump_boundary.py $DATA_DIR --ckpt-path $CKPT_PATH/checkpoint_best.pt --user-dir $USER_DIR --split "discrete_speech_valid_clsattnbndkmeans|text_valid"
